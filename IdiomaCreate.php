        ...
        <div clas="span10 offset1">
          <div class="card">
            <div class="card-header">
                <h3 class="well"> Adicionar Idioma </h3>
            </div>
            <div class="card-body">
            <form class="form-horizontal" action="IdiomaCreate.php" method="post">
...
<?php
    ...
    {   
        ...
        if($validacao)
        {
            ...
            $q = $pdo->prepare($sql);
            $resultado=$q->execute(array($nome,$ultima_atualizacao));
            Conexao::disconnect();
            ...
            header("Location: IdiomaRead.php");
        }
    } 
?>