...
?>
    ...
    <head>
        ...
        <title>Informações do Aluguel</title>
    </head>
        ...
        <div class="container">
            <div class="span10 offset1">
                  <div class="card">
                    ...
                    <h3 class="well">Informações do Aluguel</h3>
                </div>
                <div class="container">
                <div class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label">Id do Aluguel</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['data_de_devolucao'];?>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <a href="AluguelIndex.php" type="btn" class="btn btn-default">Voltar</a>
                    </div>
                  </div>
                  </div>
                </div>
