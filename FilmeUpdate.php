<?php
    ...
    if ( !empty($_POST)){
		...
		if ($validacao){
                ...
                $idioma_original_id = $data['idioma_original_id'];
                $duracao_da_locacao = $data['duracao_da_locacao'];
                $preco_da_locacao = $data['preco_da_locacao'];
                $duracao_do_filme = $data['duracao_do_filme'];
                $custo_de_substituicao = $data['custo_de_substituicao'];
                $classificacao = $data['classificacao'];
                $recursos_especiais = $data['recursos_especiais'];
    ...
    <body>
        <div class="container">
            ...
            <div class="span10 offset1">
                    ...
                    <h3 class="well"> Atualizar Filme </h3>
                </div>
					<div class="card-body">
                <form class="form-horizontal" action="FilmeUpdate.php?filme_id=<?php echo $id?>" method="post">
