...
<body>
        <div class="container">
          <div class="jumbotron">
            ...
            <div class="row">
                <p>
                    <a href="ClienteCreate.php" class="btn btn-success">Adicionar</a>
                </p>
                <table border= 1 class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach($pdo->query($sql)as $row)
                        {
                            ...
                            echo '<td width=250>';
                            echo '<a class="btn btn-primary" href="clienteRead.php?cliente_id='.$row['cliente_id'].'">Info</a>';
                            echo ' ';
                            echo '<a class="btn btn-warning" href="clienteUpdate.php?cliente_id='.$row['cliente_id'].'">Atualizar</a>';
                            echo ' ';
                            echo '<a class="btn btn-danger" href="clienteDelete.php?cliente_id='.$row['cliente_id'].'">Excluir</a>';
                            echo '</td>';
                            echo '</tr>';
                        }
                        Conexao::disconnect();
