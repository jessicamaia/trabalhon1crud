...
?>
    ...
    <head>
        ...
        <title>Informações do Endereço</title>
    </head>
        ...
        <div class="container">
            <div class="span10 offset1">
                  <div class="card">
                    ...
                    <h3 class="well">Informações do Endereço</h3>
                </div>
                <div class="container">
                <div class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label">Id do endereço:</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label">Endereço2:</label>
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['endereco2'];?>
                            </label>
                        </div>
                    </div>
